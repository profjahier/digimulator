...
edit_text = tk.Text(frame_txt, width=80, height=25, background='black')
...
text_RAM = tk.Text(frame_dbg, width=32, height=32, bg='black')
text_RAM.tag_config("pc", background="red")
